% This script answers question 4 by finding the eigenvectors and
% eigenvalues of the 4x4 A matrix derrived in Question4.m, along with their
% correspoding damping ratios and natural frequencies
